...
class FileReader {
     ...
     * Calling arguments: String path : Path of the file (where it's located in the computer)
     * Return value: Vector<Fellowship> (result of reading the file and turning lines to objects to store)
     ...
     * Description of the Method: Method that reads a given file
     * Calling arguments: Vector<Fellowship> vector : Vector that we have to fill with fellowships
     * Required Files:  fellowshipsX.txt
